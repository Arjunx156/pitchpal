...
export const UI: Record<LanguageCode, UiStrings> = {
  en: {
    ...
    modeAnnouncement: 'Assistant mode: {mode}',
  ...
  es: {
    ...
    modeAnnouncement: 'Modo del asistente: {mode}',
  ...
  fr: {
    ...
    modeAnnouncement: "Mode de l'assistant : {mode}",
  ...
  pt: {
    ...
    modeAnnouncement: 'Modo do assistente: {mode}',
  ...
  ar: {
    ...
    modeAnnouncement: 'وضع المساعد: {mode}',
